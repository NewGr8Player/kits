...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title><!-- page/${moduleName}/${moduleName}Add.jsp --></title>
        ...
        <script src="<%=basePath%>static/libs/js/form/datePicker/WdatePicker.js" type="text/javascript"></script>
        </#if>
	        ...
	        <div class="box1">
	            <s:form method="post" id="${moduleName}Form">
	                ...
	                <#list table.baseColumns as column>
	                    <tr>
	                        <td><#if (!column.nullable)><span class="star">*</span></#if>${column.remarks}：</td>
	                        <td>
		                        <#if (column.isDate() )>
	                            <s:textfield name="${moduleName}.${column.javaProperty}" readonly="true" cssClass="date validate[<#if (!column.nullable)>required,</#if>custom[date]]">
