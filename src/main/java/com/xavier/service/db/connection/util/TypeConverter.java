...
public class TypeConverter {
	...
	static {
		...
		typeToName.put(TypeConverter.NCHAR, TYPE_NCHAR);
		typeToName.put(TypeConverter.NCLOB, TYPE_NCLOB);
		typeToName.put(TypeConverter.NVARCHAR, TYPE_NVARCHAR);
		typeToName.put(TypeConverter.LONGNVARCHAR, TYPE_LONGNVARCHAR);
		...
		nameToType.put(TYPE_NCHAR, TypeConverter.NCHAR);
		nameToType.put(TYPE_NCLOB, TypeConverter.NCLOB);
		nameToType.put(TYPE_NVARCHAR, TypeConverter.NVARCHAR);
		nameToType.put(TYPE_LONGNVARCHAR, TypeConverter.LONGNVARCHAR);
	...
	public static String getTypeName(Integer typeCode) {
		return typeToName.get(typeCode);
	}
}
